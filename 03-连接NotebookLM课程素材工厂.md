...
> 前置条件：已经完成 `02-连接Obsidian第二大脑.md`，Claude Code 已连接 `obsidian-secondbrain`，NotebookLM CLI 已登录。
...
```text
/Users/qiaozhanglong/Digital_Brain/乔帮主第二大脑配置包/NotebookLM课程素材/
```

如果用户使用别的路径，请 Claude Code 先询问实际路径。
...
```bash
mkdir -p "/Users/qiaozhanglong/Digital_Brain/乔帮主第二大脑配置包/NotebookLM课程素材"
```
...
```text
/Users/qiaozhanglong/Digital_Brain/乔帮主第二大脑配置包/NotebookLM课程素材/正式版1.0/
```
